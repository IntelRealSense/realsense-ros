...
void RS435Node::setParam(rs435_paramsConfig &config, rs435_param param)
{
    ...
    case rs435_depth_exposure:
        _sensors[DEPTH].set_option(rs2_option::RS2_OPTION_EXPOSURE, config.rs435_depth_exposure * 20);
        break;
    case rs435_depth_laser_power:
        _sensors[DEPTH].set_option(rs2_option::RS2_OPTION_LASER_POWER, config.rs435_depth_laser_power * 30);
        break;
