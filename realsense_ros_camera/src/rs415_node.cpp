...
void RS415Node::setParam(rs415_paramsConfig &config, rs415_param param)
{
    ...
    case rs415_color_white_balance:
        _sensors[COLOR].set_option(rs2_option::RS2_OPTION_WHITE_BALANCE, config.rs415_color_white_balance * 10);
        break;
    ...
    case rs415_depth_exposure:
        _sensors[DEPTH].set_option(rs2_option::RS2_OPTION_EXPOSURE, config.rs415_depth_exposure * 20);
        break;
    case rs415_depth_laser_power:
        _sensors[DEPTH].set_option(rs2_option::RS2_OPTION_LASER_POWER, config.rs415_depth_laser_power * 30);
        break;
