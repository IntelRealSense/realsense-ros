...
def main():
    ...
    accel_sub = test_node.create_subscription(Metadata, '/accel/metadata', accel_metadata_cb,
                                         custom_qos)
    color_sub = test_node1.create_subscription(Metadata, '/color/metadata', color_metadata_cb,
                                         custom_qos)
    depth_sub = test_node2.create_subscription(Metadata, '/depth/metadata', depth_metadata_cb,
                                         custom_qos)
    gyro_sub = test_node3.create_subscription(Metadata, '/gyro/metadata', gyro_metadata_cb, custom_qos)
    ir1_sub = test_node4.create_subscription(Metadata, '/infra1/metadata', infra1_metadata_cb,
                                       custom_qos)
    ir2_sub = test_node5.create_subscription(Metadata, '/infra2/metadata', infra2_metadata_cb,
                                       custom_qos)
    ...
    executor.add_node(test_node2)
    executor.add_node(test_node3)
    executor.add_node(test_node4)
    executor.add_node(test_node5)

    executor.spin()
    executor.shutdown()
    test_node.destroy_node()
    test_node1.destroy_node()
    test_node2.destroy_node()
    test_node3.destroy_node()
    test_node4.destroy_node()
    test_node5.destroy_node()
