...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.width',             'default': '-1', 'description': 'color image width'},                           
                           {'name': 'rgb_camera.height',            'default': '-1', 'description': 'color image height'},                           
                           {'name': 'rgb_camera.fps',               'default': '-1', 'description': "''"},                           
