...
namespace realsense2_camera
{
    ...
    /* Modified for Brain */
    const int FRAME_MAX_HEIGHT = 720;
    const int FRAME_MAX_WIDTH = 1280;
    const int FRAME_PRIME_HEIGHT = 240;
    const int FRAME_PRIME_WIDTH = 424;
    const int STEP = 12;
    const float DEFAULT_THLD = 0.95;
