...
namespace realsense_ros_object
{
	...
	void COrmgr::init(ros::NodeHandle& nh)
	{
		...
		m_objects_to_track_pub = m_nh.advertise<realsense_ros_object::TrackedObjectsArray>("realsense/objects_to_track", 1);
		m_tracked_localized_pub = m_nh.advertise<realsense_ros_object::ObjectsInBoxes>("realsense/localized_tracked_objects", 1);
	 }
