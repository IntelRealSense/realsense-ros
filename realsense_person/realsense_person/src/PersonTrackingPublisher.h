...
#include "realsense_pt_msgs/User.h"
#include "realsense_pt_msgs/Frame.h"
...
private:
  void addBlobToOutput(PXCPersonTrackingData::PersonTracking * personData, realsense_pt_msgs::User & user);
  void addSkeletonToOutput(PXCPersonTrackingData::Person * personData, realsense_pt_msgs::User & user);
  void addGesturesToOutout(PXCPersonTrackingData::Person * personData, realsense_pt_msgs::User & user);
