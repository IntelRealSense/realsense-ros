...
- ***<stream_type>*_qos**: <stream_type> can be any of *infra, color, fisheye, depth, gyro, accel, pose, confidence, pointcloud, gyro, accel, pose, imu_info, infra_info, color_info,fisheye_info, depth_info, gyro_info, accel_info, pose_info, fisheye_extrinsics, color_extrinsics, infra_extrinsics*. Sets the QoS by which the topic is published. Available values are the following strings: SYSTEM_DEFAULT, PARAMETER_EVENTS, SERVICES_DEFAULT, PARAMETERS, DEFAULT, SENSOR_DATA.
